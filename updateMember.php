<?php
    ...
    $result = mysqli_query($con,"SELECT * FROM ClubMember WHERE ClubID='".$id);
    ...
    <form action="viewMember.php?job=update" method="post">
        <input name="ID" type="hidden" value=<?php echo $row['MemberID'];?>>
